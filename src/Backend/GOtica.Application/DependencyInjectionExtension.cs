...
public static class DependencyInjectionExtension
{
    ...
    private static void AddUseCases(IServiceCollection services)
    {
        ...
        services.AddScoped<IGetAllPrescriptionsUseCase, GetAllPrescriptionsUseCase>();
        #endregion
        ...
        services.AddScoped<IMarkSaleAsReadyUseCase, MarkSaleAsReadyUseCase>();
        services.AddScoped<IDeliverSaleUseCase, DeliverSaleUseCase>();
        services.AddScoped<IReceivePaymentUseCase, ReceivePaymentUseCase>();
        ...
        services.AddScoped<IUpdateTreatmentUseCase, UpdateTreatmentUseCase>();
        services.AddScoped<IDeactivateTreatmentUseCase, DeactivateTreatmentUseCase>();
        services.AddScoped<IReactivateTreatmentUseCase, ReactivateTreatmentUseCase>();
        #endregion
    }

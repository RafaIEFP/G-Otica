...
public class RegisterSupplierValidator : AbstractValidator<RequestRegisterSupplier>
{
    public RegisterSupplierValidator()
    {
        RuleFor(request => request.Name).NotEmpty().WithMessage(ResourceMessagesException.NAME_EMPTY).MaximumLength(255);
